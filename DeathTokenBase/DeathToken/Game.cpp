...
vector<Game::TextureSpec> Game::loadTextures() {
	...
	v.push_back(TextureSpec{ "Fighters/skeletor.png", 1, 1 });
	v.push_back(TextureSpec{ "Fighters/romelario.png", 1, 1 });
	v.push_back(TextureSpec{ "Fighters/alfredo.png", 1, 1 });
	v.push_back(TextureSpec{ "Fighters/boodoo.png", 1, 1 });
	v.push_back(TextureSpec{ "Fighters/corneo.png", 1, 1 });
	v.push_back(TextureSpec{ "Fighters/mcdougald.png", 1, 1 }); 
	v.push_back(TextureSpec{"Fighters/paulter_geist.png", 1, 1 });
	v.push_back(TextureSpec{ "Fighters/potape.png", 1, 1 }); 
