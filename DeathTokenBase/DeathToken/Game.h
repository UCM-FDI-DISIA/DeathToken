...
enum TypoName { GRAND_CASINO, AWARD, FIGHTS_BIG, FIGHTS_SMALL, NUM_TYPO };
...
public:
  ...
  static void inicializa(SDL_Window* window)
  {
  ...
  inline const Matchup& GetMatchUp(int i) const
  {
    assert(i < battleQueue.size());
