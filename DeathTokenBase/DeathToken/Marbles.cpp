...
Marbles::Marbles(Game* game) : GameState(game), texture(game->getTexture(MARBLESBACK)) {
	...
	//VERDE
	buttonType1_2 = new Button(this, Game::WIN_WIDTH / 2 - PosPW1, Game::WIN_HEIGHT - Game::WIN_HEIGHT / 4 - PosPH1, PosPW1, PosPH1, game->getTexture(BUTTONMARBLES1));
	addObjects(buttonType1_2);
	addEventListener(buttonType1_2);
	//AZUL
	buttonType1_3 = new Button(this, Game::WIN_WIDTH / 2, Game::WIN_HEIGHT - Game::WIN_HEIGHT / 4 - PosPH1 - PosPH1, PosPW1, PosPH1, game->getTexture(BUTTONMARBLES1));
	...
	//ROJO/VERDE
	buttonType2_1 = new Button(this, Game::WIN_WIDTH / 2 - 3 * PosPW2 - PosPW1, Game::WIN_HEIGHT - Game::WIN_HEIGHT / 4 - PosPH2 - PosPH2, PosPW2, PosPH2, game->getTexture(BUTTONMARBLES2));
	addObjects(buttonType2_1);
	addEventListener(buttonType2_1);
	//ROJO/ROJO
	buttonType2_2 = new Button(this, Game::WIN_WIDTH / 2 - 2 * PosPW2 - PosPW1, Game::WIN_HEIGHT - Game::WIN_HEIGHT / 4 - PosPH1 - PosPH2, PosPW2, PosPH2, game->getTexture(BUTTONMARBLES2));
	addObjects(buttonType2_2);
	addEventListener(buttonType2_2);
	//VERDE/VERDE
	buttonType2_3 = new Button(this, Game::WIN_WIDTH / 2 - 2 * PosPW2 - PosPW1, Game::WIN_HEIGHT - Game::WIN_HEIGHT / 4 - PosPH1, PosPW2, PosPH2, game->getTexture(BUTTONMARBLES2));
	addObjects(buttonType2_3);
	addEventListener(buttonType2_3);
	//ROJO/AMARILLO
	buttonType2_4 = new Button(this, Game::WIN_WIDTH / 2 - PosPW2 - PosPW1, Game::WIN_HEIGHT - Game::WIN_HEIGHT / 4 - PosPH1 - PosPH2, PosPW2, PosPH2, game->getTexture(BUTTONMARBLES2));
	addObjects(buttonType2_4);
	addEventListener(buttonType2_4);
	//VERDE/AZUL
	buttonType2_5 = new Button(this, Game::WIN_WIDTH / 2 - PosPW2 - PosPW1, Game::WIN_HEIGHT - Game::WIN_HEIGHT / 4 - PosPH1, PosPW2, PosPH2, game->getTexture(BUTTONMARBLES2));
	addObjects(buttonType2_5);
	addEventListener(buttonType2_5);
	//ROJO/AZUL
	buttonType2_6 = new Button(this, Game::WIN_WIDTH / 2 + PosPW1, Game::WIN_HEIGHT - Game::WIN_HEIGHT / 4 - PosPH1 - PosPH2, PosPW2, PosPH2, game->getTexture(BUTTONMARBLES2));
	addObjects(buttonType2_6);
	addEventListener(buttonType2_6);
	//VERDE/AMARILLO
	buttonType2_7 = new Button(this, Game::WIN_WIDTH / 2 + PosPW1, Game::WIN_HEIGHT - Game::WIN_HEIGHT / 4 - PosPH1, PosPW2, PosPH2, game->getTexture(BUTTONMARBLES2));
	addObjects(buttonType2_7);
	addEventListener(buttonType2_7);
	//AZUL/AZUL
	buttonType2_8 = new Button(this, Game::WIN_WIDTH / 2 + PosPW2 + PosPW1, Game::WIN_HEIGHT - Game::WIN_HEIGHT / 4 - PosPH1 - PosPH2, PosPW2, PosPH2, game->getTexture(BUTTONMARBLES2));
	addObjects(buttonType2_8);
	addEventListener(buttonType2_8);
	//AMARILLO/AMARILLO
	buttonType2_9 = new Button(this, Game::WIN_WIDTH / 2 +  PosPW2 + PosPW1, Game::WIN_HEIGHT - Game::WIN_HEIGHT / 4 - PosPH1, PosPW2, PosPH2, game->getTexture(BUTTONMARBLES2));
	addObjects(buttonType2_9);
	addEventListener(buttonType2_9);
	//AMARILLO/AZUL
	buttonType2_10 = new Button(this, Game::WIN_WIDTH / 2 + 2 * PosPW2 + PosPW1, Game::WIN_HEIGHT - Game::WIN_HEIGHT / 4 - PosPH2 - PosPH2, PosPW2, PosPH2, game->getTexture(BUTTONMARBLES2));
	...
	//ROJO/ROJO/ROJO
	buttonType3_1 = new Button(this, Game::WIN_WIDTH / 2 - 2*PosPW3 - PosPW1, Game::WIN_HEIGHT - Game::WIN_HEIGHT / 4 - 2 * PosPH1 - (PosPH4 - PosPH4 / 4), PosPW3, PosPH3, game->getTexture(BUTTONMARBLES3));
	addObjects(buttonType3_1);
	addEventListener(buttonType3_1);
	//VERDE/VERDE/VERDE
	buttonType3_2 = new Button(this, Game::WIN_WIDTH / 2 - PosPW3 - PosPW1, Game::WIN_HEIGHT - Game::WIN_HEIGHT / 4   - 2*PosPH1 - (PosPH4- PosPH4/4), PosPW3, PosPH3, game->getTexture(BUTTONMARBLES3));
	addObjects(buttonType3_2);
	addEventListener(buttonType3_2);
	//AZUL/AZUL/AZUL
	buttonType3_3 = new Button(this, Game::WIN_WIDTH / 2 + PosPW1, Game::WIN_HEIGHT - Game::WIN_HEIGHT / 4 - 2 * PosPH1 - (PosPH4 - PosPH4 / 4), PosPW3, PosPH3, game->getTexture(BUTTONMARBLES3));
	addObjects(buttonType3_3);
	addEventListener(buttonType3_3);
	//AMARILLO/AMARILLO/AMARILLO
	buttonType3_4 = new Button(this, Game::WIN_WIDTH / 2 + PosPW3 + PosPW4/2, Game::WIN_HEIGHT - Game::WIN_HEIGHT / 4 - 2 * PosPH1 - (PosPH4 - PosPH4 / 4), PosPW3, PosPH3, game->getTexture(BUTTONMARBLES3));
	...
	buttonType4_1 = new Button(this, Game::WIN_WIDTH / 2 - PosPW1, Game::WIN_HEIGHT - Game::WIN_HEIGHT / 4 - PosPH1 - PosPH1 - PosPH4, PosPW4, PosPH4, game->getTexture(BUTTONMARBLES4));
