...
void Slots::update() {
	...
	if (comprobanteIndice == 3) {
		...
		for (int i = 0; i < N_COLUM; ++i) {
			...
			bool telara�as1_2 = vectorCarrete1[i] == vectorCarrete2[i] && vectorCarrete1[i] == 0;
			bool telara�as1_3 = vectorCarrete1[i] == vectorCarrete3[i] && vectorCarrete1[i] == 0;
			bool telara�as2_3 = vectorCarrete2[i] == vectorCarrete3[i] && vectorCarrete2[i] == 0;

			if (vectorCarrete1[i] == vectorCarrete2[i] && vectorCarrete2[i] == vectorCarrete3[i]) {
				
				multiplicador += multiplicadores[vectorCarrete1[i]];
			}
			else if (telara�as1_2 || telara�as1_3 || telara�as2_3) {
